...
const router = new VueRouter({
  ...
  routes:[
    ...
    },
    {
      path: '/issues',
      name: 'Issues',
      component: () => import('../views/dev/Issues.vue')
    },
    {
      path: '/issues/new',
      name: 'New Issue',
      component: () => import('../views/dev/NewIssue.vue')
    },
    {
      path: '/issues/:id',
      name: 'Issue Detail',
      component: () => import('../views/dev/IssueDetail.vue')
    },
    {
      path: '/issues/:id/edit',
      name: 'Edit Issue',
    ...
    },
    {
      ...
      path: '/static-analysis/:projectKey',
      name: '静态代码analysis',
      component: () => import('../views/SonarQube/Screen.vue')
    },{
      path: '/chatAI',
      name: '和大语言模型对话',
      component: () => import('../views/user/AI/Llvm.vue')
    },{
      path: '/editor',
      name: 'editor',
      component: () => import('../views/Editor.vue'), props: router => ({
